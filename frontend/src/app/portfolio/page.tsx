...
import {
  ...
  AlertTriangle, Target, DollarSign, BarChart3, ArrowUpRight, ArrowDownRight
} from "lucide-react"
...
const summaryCards = [
  ...
  { label: "Sharpe Ratio", value: "1.84", change: "+0.12", positive: true, icon: BarChart3 },
]
...
const riskMetrics = [
  ...
  { label: "Leverage Ratio", value: "1.2x", status: "good" },
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        ...
        >
          ...
          <p className="mt-2 text-muted-foreground">Track your positions, performance, and risk metrics</p>
        </motion.div>
